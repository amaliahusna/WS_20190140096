...
import ti.umy.assessment.exceptions.NonexistentEntityException;
import ti.umy.assessment.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy_assessment_jar_0.0.1-SNAPSHOTPU");
